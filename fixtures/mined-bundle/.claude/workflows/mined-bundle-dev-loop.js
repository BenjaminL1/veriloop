...
// <<< veriloop:auto:start >>>
export const meta = {
  "name": "mined-bundle-dev-loop",
  "description": "Per-feature dev loop for mined-bundle: plan(vs constitution) -> triage -> worktree implement -> risk-tiered gate(real exit-code checks + review lenses) -> bounded auto-fix -> docs sync -> push preview. Stops before merge.",
  "phases": [
    {
      "title": "Plan",
